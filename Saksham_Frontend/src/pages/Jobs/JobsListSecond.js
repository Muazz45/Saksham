...
export const JobsListSecond = () => {
    ...
    useEffect(() => {
        if (sessionStorage.getItem("job") === "") {
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.location":sessionStorage.getItem("location")}).then((response) => {
                setData({
            ...
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.title":sessionStorage.getItem("job")}).then((response) => {
                setData({
                    getData: response.data.data.jobs
                });
                console.log(response.data.data.jobs);
            ...
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.title":sessionStorage.getItem("job"),"jobInfo.location":sessionStorage.getItem("location")}).then((response) => {
                setData({
                    getData: response.data.data.jobs
                });
                console.log(response.data.data.jobs);
