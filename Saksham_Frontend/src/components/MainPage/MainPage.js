...
export const MainPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (searchjob.current.value === "") {
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.location":searchlocation.current.value}).then((response) => {
                setData({
            ...
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.title":searchjob.current.value}).then((response) => {
                setData({
                    getData: response.data.data.jobs
                });
            ...
            axios.post('http://localhost:8000/findAllJobPos',{"jobInfo.title":searchjob.current.value,"jobInfo.location":searchlocation.current.value}).then((response) => {
                setData({
                    getData: response.data.data.jobs
                });
                console.log(response.data.data.jobs);
